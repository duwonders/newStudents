    ...
    (function(){//开学倒计时
    	...
    	function timer(){
    		var now = new Date().getTime(),
                ...
                var href = "Public/image/num";
                dayH.children[0].src = href+(day + "").slice(0,1)+".png";
                dayH.children[1].src = href+(day + "").slice(1,2)+".png";
                houtH.children[0].src = href+(hour + "").slice(0,1)+".png";
                houtH.children[1].src = href+(hour + "").slice(1,2)+".png";
                branchH.children[0].src = href+(branch + "").slice(0,1)+".png";
                branchH.children[1].src = href+(branch + "").slice(1,2)+".png";
                secondsH.children[0].src = href+(seconds + "").slice(0,1)+".png";
                secondsH.children[1].src = href+(seconds+ "").slice(1,2)+".png";
    ...
    (function(){//其他动画
        ...
        eventHandler.addEvent(d1,"click",function(){
            window.location.href = "/newFace/index.php?m=Home&c=Map&a=index";
        })
