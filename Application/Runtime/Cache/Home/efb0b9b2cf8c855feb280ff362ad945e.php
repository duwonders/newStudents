...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/newFace/Public/css/windcolor.css">
</head>
<body>
    <div id="wap">  
    </div>
        ...
        <div class="header" id="header">
            <div class="header_container">
                <ul class="nav">
                    ...
                    <li>
                        <a href="<?php echo U('Data/index');?>" id="showdat1">大数据</a>
                    </li>
                    <li>
                        <a href="<?php echo U('Page/index');?>">重邮百科</a>
                    </li>
                    <li class="windcolor_t">
                        <a href="<?php echo U('Windcolor/index');?>">重邮风彩</a>
                    </li>
                    <li>
                        <a href="">大声HI</a>
                    </li>
        ...
        <div class="header" id="H">
            <div class="header_container">
                <ul class="nav">
                    ...
                    <li>
                        <a href="<?php echo U('Data/index');?>" id="showdat2">大数据</a>
                    </li>
                    <li>
                        <a href="<?php echo U('Page/index');?>">重邮百科</a>
                    </li>
    ...
    <div class="container">
        ...
        <div class="container_content">
            ...
            <div class="mapwrapper">
                ...
                <img src="/newFace/Public/image/color_title.png" alt="" class="maptitle">
                <div class = "mapstatic">
                    <div id="D2map" class="page">
                        ...
                        <div class="page_mid_big" id="color_choose">
                            <div class="page_mid" style="display:none">
                                <ul class="page_img_ul" id="stu">
                                    <li class="page_img page_img_spe" ><a  href="/newFace/Public/image/person_1.png" rel="lightbox" title="孝老敬亲之星-蔡长庆"></a>
                                        <span >孝老敬亲之星-蔡长庆</span></li>
                                    <li class="page_img"><a  href="/newFace/Public/image/person_2.png" rel="lightbox" title="党员模范之星-王斌"></a>
                                        <span>党员模范之星-王斌</span></li>
                                    <li class="page_img"><a  href="/newFace/Public/image/person_3.png" rel="lightbox" title="才艺特长之星-张永晖"></a>
                                        <span>才艺特长之星-张永晖</span></li>
                                    <li class="page_img"><a  href="/newFace/Public/image/person_4.png" rel="lightbox" title="健康运动之星-高全利"></a>
                                        <span>健康运动之星-高全利</span></li>
                                    <li class="page_img" style="margin-top:67px;"><a  href="/newFace/Public/image/person_5.png" rel="lightbox" title="网络建设之星-蒋子良"></a>
                                        <span>网络建设之星-蒋子良</span></li>
                                    <li class="page_img" style="margin-top:67px;"><a  href="/newFace/Public/image/person_6.png" rel="lightbox" title="科技创新之星-叶升蔚"></a>
                                        <span>科技创新之星-叶升蔚</span></li>
                                    <li class="page_img" style="margin-top:67px;"><a  href="/newFace/Public/image/person_7.png" rel="lightbox" title="自立自强之星-阮福亮"></a>
                                        <span>自立自强之星-阮福亮</span></li>
                                    <li class="page_img" style="margin-top:67px;"><a  href="/newFace/Public/image/person_8.png" rel="lightbox" title="勤奋好学之星-肖颖"></a>
                            ...
                            <div class="page_mid" style="display:none">
                                <div style="height:500px;" id="teacher_page">
                                    <div class="page_fix" style="display:block" >
                                        <ul class="page_img_ul" id="teacher_1">
                                            <li class="page_img page_img_spe" ><a   rel="lightbox" href="/newFace/Public/image/teacher_1"></a>
                                                <span >传媒艺术学院-王睿</span></li>
                                            <li class="page_img"><a  rel="lightbox" href="/newFace/Public/image/teacher_2"></a>
                                                <span>体育学院-王樱桃</span></li>
                                            <li class="page_img"><a   rel="lightbox" href="/newFace/Public/image/teacher_3" ></a>
                                                <span>自动化学院-付蔚</span></li>
                                            <li class="page_img"><a   rel="lightbox" href="/newFace/Public/image/teacher_4"></a>
                                                <span>理学院-朱伟</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a   rel="lightbox" href="/newFace/Public/image/teacher_5"></a>
                                                <span>理学院-张清华</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a   rel="lightbox" href="/newFace/Public/image/teacher_6"></a>
                                                <span>马克思主义学院-闵绪国</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a   rel="lightbox" href="/newFace/Public/image/teacher_7"></a>
                                                <span>传媒艺术学院-陈祺祺</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a  rel="lightbox" href="/newFace/Public/image/teacher_8"></a>
                                            <span>生物信息学院-袁帅</span></li>
                                        </ul>
                                    </div>
                                    <div class="page_fix" style="display:none" >
                                        <ul class="page_img_ul" id="teacher_2">
                                            <li class="page_img page_img_spe" ><a   rel="lightbox" href="/newFace/Public/image/teacher_9"></a>
                                                <span >外国语学院-高非</span></li>
                                            <li class="page_img"><a  rel="lightbox" href="/newFace/Public/image/teacher_10"></a>
                                                <span>通信与信息工程学院-漆晶</span></li>
                                            <li class="page_img"><a   rel="lightbox" href="/newFace/Public/image/teacher_11"></a>
                                                <span>理学院-周贤菊</span></li>
                                            <li class="page_img"><a   rel="lightbox" href="/newFace/Public/image/teacher_12"></a>
                                                <span>光电工程学院-罗元</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a   rel="lightbox" href="/newFace/Public/image/teacher_13"></a>
                                                <span>理学院-郑继明</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a   rel="lightbox" href="/newFace/Public/image/teacher_14"></a>
                                                <span>通信与信息工程学院-胡庆</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a   rel="lightbox" href="/newFace/Public/image/teacher_15"></a>
                                                <span>体育学院-高冬</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a  rel="lightbox" href="/newFace/Public/image/teacher_16"></a>
                                            <span>法学院-彭学良</span></li>
                                        </ul>
                                    </div>
                                     <div class="page_fix" style="display:none" >
                                        <ul class="page_img_ul" id="teacher_3">
                                            <li class="page_img page_img_spe" ><a   rel="lightbox" href="/newFace/Public/image/teacher_17"></a>
                                                <span >通信与信息工程学院-蒋青</span></li>
                                            <li class="page_img"><a  rel="lightbox" href="/newFace/Public/image/teacher_18"></a>
                                                <span style="font-size:13px;">计算机科学与技术学院-熊安萍</span></li>
                                            <li class="page_img"><a  rel="lightbox" href="/newFace/Public/image/teacher_19"></a>
                                                <span>外国语学院-张琬悦</span></li>
                                            <li class="page_img"><a  rel="lightbox" href="/newFace/Public/image/teacher_20"></a>
                                ...
                                <div class="page_bottom">
                                    <ul class="page_bottom_ul" id="teacher_choose">
                                        ...
                                        <li class="page_bottom_li"><a class="page_bottom_spe">1</a></li>
                                ...
                                <div style="height:500px;" id="pic_main">
                                    <div class="page_fix" style="display:block;">
                                        <ul class="page_img_ul" id="win_img_1">
                                            <li class="page_img page_img_spe" ><a  href="/newFace/Public/image/color_0.jpg" rel="lightbox" title="五栋篮球场"></a>
                                                <span >第零页</span></li>
                                            <li class="page_img"><a  href="/newFace/Public/image/color_1.jpg" rel="lightbox" title="数字图书馆"></a>
                                                <span>数字图书馆</span></li>
                                            <li class="page_img"><a  href="/newFace/Public/image/color_2.jpg" rel="lightbox" title="校园一角"></a>
                                                <span>校园一角</span></li>
                                            <li class="page_img"><a  href="/newFace/Public/image/color_3.jpg" rel="lightbox" title="我只是一个摄影爱好者"></a>
                                                <span>我只是一个摄影爱好者</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a  href="/newFace/Public/image/color_4.jpg" rel="lightbox" title="似梦似幻"></a>
                                                <span>似梦似幻</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a  href="/newFace/Public/image/color_5.jpg" rel="lightbox" title="学生活动中心昼与夜"></a>
                                                <span>学生活动中心昼与夜</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a  href="/newFace/Public/image/color_6.jpg" rel="lightbox" title="落英缤纷"></a>
                                                <span>落英缤纷</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a  href="/newFace/Public/image/color_7.jpg" rel="lightbox" title="二教"></a>
                                                <span>二教</span></li>
                                        </ul>
                                    </div>
                                    <div class="page_fix" style="display:none;">
                                        <ul class="page_img_ul" id="win_img_2">
                                            <li class="page_img page_img_spe" ><a  href="/newFace/Public/image/color_8.jpg" rel="lightbox" title="五栋篮球场"></a>
                                                <span >第二页</span></li>
                                            <li class="page_img"><a  href="/newFace/Public/image/color_9.jpg" rel="lightbox" title="数字图书馆"></a>
                                                <span>数字图书馆</span></li>
                                            <li class="page_img"><a  href="/newFace/Public/image/color_10.jpg" rel="lightbox" title="校园一角"></a>
                                                <span>校园一角</span></li>
                                            <li class="page_img"><a  href="/newFace/Public/image/color_11.jpg" rel="lightbox" title="我只是一个摄影爱好者"></a>
                                                <span>我只是一个摄影爱好者</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a href="/newFace/Public/image/color_12.jpg" rel="lightbox" title="似梦似幻"></a>
                                                <span>似梦似幻</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a  href="/newFace/Public/image/color_13.jpg" rel="lightbox" title="学生活动中心昼与夜"></a>
                                                <span>学生活动中心昼与夜</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a  href="/newFace/Public/image/color_14.jpg" rel="lightbox" title="落英缤纷"></a>
                                                <span>落英缤纷</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a  href="/newFace/Public/image/color_15.jpg" rel="lightbox" title="二教"></a>
                                                <span>二教</span></li>
                                        </ul>
                                    </div>
                                    <div class="page_fix" style="display:none;">
                                        <ul class="page_img_ul" id="win_img_3">
                                            <li class="page_img page_img_spe" ><a  href="/newFace/Public/image/color_16.jpg" rel="lightbox" title="五栋篮球场"></a>
                                                <span >第三页</span></li>
                                            <li class="page_img"><a  href="/newFace/Public/image/color_17.jpg" rel="lightbox" title="数字图书馆"></a>
                                                <span>数字图书馆</span></li>
                                            <li class="page_img"><a  href="/newFace/Public/image/color_18.jpg" rel="lightbox" title="校园一角"></a>
                                                <span>校园一角</span></li>
                                            <li class="page_img"><a  href="/newFace/Public/image/color_19.jpg" rel="lightbox" title="我只是一个摄影爱好者"></a>
                                                <span>我只是一个摄影爱好者</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a  href="/newFace/Public/image/color_20.jpg" rel="lightbox" title="似梦似幻"></a>
                                                <span>似梦似幻</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a  href="/newFace/Public/image/color_21.jpg" rel="lightbox" title="学生活动中心昼与夜"></a>
                                                <span>学生活动中心昼与夜</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a  href="/newFace/Public/image/color_22.jpg" rel="lightbox" title="落英缤纷"></a>
                                                <span>落英缤纷</span></li>
                                            <li class="page_img" style="margin-top:67px;"><a  href="/newFace/Public/image/color_23.jpg" rel="lightbox" title="二教"></a>
                                                <span>二教</span></li>
                                        </ul>
                                    </div>
                                    <div class="page_fix" style="display:none;">
                                        <ul class="page_img_ul" id="win_img_4">
                                            <li class="page_img page_img_spe" ><a  href="/newFace/Public/image/color_24.jpg" rel="lightbox" title="五栋篮球场"></a>
                                                <span >第四页</span></li>
                                            <li class="page_img"><a  href="/newFace/Public/image/color_25.jpg" rel="lightbox" title="数字图书馆"></a>
                                                <span>数字图书馆</span></li>
                                        </ul>
                                    </div>
                                </div>
    ...
    <script src="/newFace/Public/js/windcolor.js"></script>
