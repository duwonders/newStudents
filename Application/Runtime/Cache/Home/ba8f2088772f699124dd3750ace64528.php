...
<head>
	<title></title>
	<meta charset="utf-8">
	<link rel="stylesheet" type="text/css" href="/newFace/Public/css/map.css">
</head>
<body>
	<div id="wap">	
	</div>
	...
	<div class="container">
		...
		<div class="container_content">
			...
			<div class="mapwrapper">
				...
				<a id = "btu_3D">街景地图</a>
				<img src="/newFace/Public/image/maptitle.png" alt="" class="maptitle">
				<div class = "mapstatic">
					<div id="D2map">
						<p>过头了哦~<br>恭喜你获得<br>拖地图狂魔称号</p>
						<img src="/newFace/Public/image/map.jpg" id="map">
						<div id="map-face"></div>
						<div id="smallmap"><img src="/newFace/Public/image/smallmap.jpg"></div>
	...
	<script src="/newFace/Public/js/map.js"></script>
